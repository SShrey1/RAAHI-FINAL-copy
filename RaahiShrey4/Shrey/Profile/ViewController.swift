...
//        var selectedItineraryDestinations: [Destination]?
//        
//        override func viewDidLoad() {
//            super.viewDidLoad()
//            
...
//            itineraryTableView.separatorInset = .init(top: 10, left: 0, bottom: 0, right: 0)
//            
//            // Fetch itineraries when the view loads
//            fetchItineraryCards()
//        }
//        
//        @IBAction func editProfileButton(_ sender: UIButton) {
...
//                    print("Forcing table view reload after delay")
...
//        }
//        
//        // MARK: - Show Destinations for Selected ItineraryCard
...
//                guard let self = self else { return }
//                self.selectedItineraryDestinations = destinations
//                self.performSegue(withIdentifier: "ShowItineraryDetails", sender: self)
//            }
//        }
//        
//        override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
//            if segue.identifier == "ShowItineraryDetails",
//               let destinationVC = segue.destination as? ItineraryDetailsViewController {
//                destinationVC.destinations = selectedItineraryDestinations
//            }
//        }
//        
//        @IBAction func logoutButtonTapped(_ sender: UIButton) {
...
//            
//            // Apply card styling
//            cell.itinerayCardView.layer.cornerRadius = 10
//            cell.itinerayCardView.layer.shadowColor = UIColor.systemGray.cgColor
//            cell.itinerayCardView.layer.shadowOpacity = 0.2
//            cell.itinerayCardView.layer.shadowOffset = CGSize(width: 0, height: 2)
//            cell.itinerayCardView.layer.shadowRadius = 4
//            
//            cell.itineraryImageView.layer.cornerRadius = 10
//            cell.itineraryImageView.clipsToBounds = true
//            
//            return cell
//        }
//        
